  ...
  return (
    <div className="h-full max-h-[100vh] bg-slate-100 ">
      ...
      <div className="flex justify-end px-1 py-1  font-semibold sm:px-3 md:hidden">
        ...
        <ul
          className={`absolute flex flex-col gap-8 bg-slate-100 z-10 w-60 pl-4 pt-4 h-screen ${
            show
              ? "top-[38px] lift-0 delay-150 transition-all"
        ...
        >
          ...
          <li
            ...
            className="flex flex-row w-full h-16 gap-2 min-h-max hover:bg-gray-200  cursor-pointer active:top-[2px] relative items-center"
          >
            <span>
